...
export const report = {
  ...
  meeting: [
    ...
    { title: "Pre-load the dashboard", when: "Day before", detail: "Open /admin-preview once so images are cached." },
    { title: "Print this report's smoke table", when: "Day before", detail: "One page. Numbers beat adjectives." },
    { title: "Open three tabs in advance", when: "Just before", detail: "/en, /ar/tours, /admin-preview." },
